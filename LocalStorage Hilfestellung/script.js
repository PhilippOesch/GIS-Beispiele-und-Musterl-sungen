"use strict";
var localStorageHilfestellung;
(function (localStorageHilfestellung) {
    ...
    let array = [14, 16, 20, 22]; //Hier habe ich ein Array angelegt
    let arrayIGotFromLocalStorage; //in dieser Variable will ich später das aus dem LocalStorage geholte Array wieder abspeichern
    ...
    let stringFromLocalStorage = localStorage.getItem("myArray"); // So hole ich Werte wieder aus dem LocalStorage heraus. Dafür brauche ich den passenden Key!
...
})(localStorageHilfestellung || (localStorageHilfestellung = {}));
